    ...
    <div className="min-h-screen bg-[#f7f9fc]">
      ...
      <main className="mx-auto max-w-5xl space-y-6 p-8">
        ...
        >
          ...
          <div className="flex items-center justify-between gap-5 border-t py-4">
            ...
            <div className="flex items-center gap-2">
              <Globe size={16} className="text-[#087f87]" />

              <select className="rounded-lg border px-3 py-2 text-sm outline-none focus:border-[#087f87]">
        ...
        >
          <button
            type="button"
            className="flex w-full items-center justify-between border-b py-4 text-left hover:bg-slate-50"
          >
            <div className="flex items-center gap-3">
              <Shield size={18} className="text-[#087f87]" />
